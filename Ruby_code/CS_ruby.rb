...
# (c) Copyright 2010 . Some Rights Reserved.
...
def decode(bitstring, search_space, bits_per_param)
  ...
  search_space.each_with_index do |bounds, i|
    ...
    #puts "bounds, #{off...(off+bits_per_param)}"
...
if __FILE__ == $0
  ...
  #puts "done! Solution: f=#{best[:cost]}, s=#{best[:vector].inspect}, b=#{best[:bitstring].inspect}"
end
