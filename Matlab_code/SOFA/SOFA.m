...
function sofa_score = SOFA(intervals,start_time,out_time,exists_bilirubin,...
    ...
    exists_platelet,exists_fio_chart,exists_fio_lab,exists_po2,...
    ...
    norepinephrine_values,mbp_values,platelet_values,fio_chart_values,...
    fio_lab_values,po2_values,ventilation_values,urine_output_values)
    ...
    if exists_fio_chart
        if exists_po2
           FIO2PO2 = fio_chart_values ./ po2_values;
           exists_FIO2PO2 = 1;
        end
    elseif exists_fio_lab
        if exists_po2
            FIO2PO2 = fio_lab_values ./ po2_values;
            exists_FIO2PO2 = 1;
        end
    end
